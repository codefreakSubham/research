...
f = open('test.txt', 'a')
f.write(f'\n Starting DataIter: {datetime.now().strftime("%H:%M:%S")}')
...
f = open('test.txt', 'a')
f.write(f'\n Ending DataIter: {datetime.now().strftime("%H:%M:%S")}')
f.close()

f = open('test.txt', 'a')
f.write(f'\n Starting convertEg: {datetime.now().strftime("%H:%M:%S")}')
f.close()
...
f = open('test.txt', 'a')
f.write(f'\n Ending convertEg: {datetime.now().strftime("%H:%M:%S")}')
f.close()
...
f = open('test.txt', 'a')
f.write(f'\n GPU Detected: {physical_devices} and time:{datetime.now().strftime("%H:%M:%S")}')
f.close()
...
f = open('test.txt', 'a')
f.write(f'\n Starting CreateGroup: {datetime.now().strftime("%H:%M:%S")}')
f.close()
...
f = open('test.txt', 'a')
f.write(f'\n Ending CreateGroup: {datetime.now().strftime("%H:%M:%S")}')
f.close()
...
f = open('test.txt', 'a')
f.write(f'\n Entering Result Loop: {datetime.now().strftime("%H:%M:%S")}')
f.close()
